...
function htmlForNotesSelection() {
    ...
    <div id="DA-NoteSelection" class="DA-NoteClefSelection">\n\
        <input type="radio" name="notes" id="note-sq" value="6">\n\
        <label for="note-sq" >&#188;</label>\n\
        \
        <input type="radio" name="notes" id="note-t" value="6.">\n\
        <label for="note-t" >&#8531;</label>\n\
        \
        <input type="radio" name="notes" id="note-q" value="8">\n\
        <label for="note-q" >&#189;</label>\n\
        \
        <input type="radio" name="notes" id="note-dq" value="8.">\n\
        <label for="note-dq" >&#190;</label>\n\
        \
        <input type="radio" name="notes" id="note-c" checked value="4">\n\
        <label for="note-c" >1</label>\n\
        \
        <input type="radio" name="notes" id="note-dc" value="4.">\n\
        <label for="note-dc" >1&#189;</label>\n\
        \
        <input type="radio" name="notes" id="note-m" value="2">\n\
        <label for="note-m" >2</label>\n\
        \
        <input type="radio" name="notes" id="note-dm" value="2.">\n\
        <label for="note-dm" >3</label>\n\
        \
        <input type="radio" name="notes" id="note-sb" value="1">\n\
        <label for="note-sb" >4</label>\n\
        \
        <input type="radio" name="notes" id="note-b" value="9">\n\
        <label for="note-b" >8</label>\n\
    </div>'
